# StreamScan: Descargo de Responsabilidades y Limitación de Responsabilidad
...
4.  **Sin Garantías:** La herramienta se proporciona "tal cual", sin garantía de ningún tipo, expresa o implícita, incluyendo, pero no limitado a, garantías de comerciabilidad, idoneidad para un propósito particular y no infracción.
5.  **Limitación de Daños:** En ningún caso el autor o los colaboradores serán responsables de daños directos, indirectos, incidentales, especiales, ejemplares o consecuentes (incluida, entre otras, la adquisición de bienes o servicios sustitutos; la pérdida de uso, datos o beneficios; o la interrupción comercial) que surjan de cualquier teoría de responsabilidad, ya sea por contrato, responsabilidad estricta o agravio (incluida negligencia o de otro tipo) que surja de cualquier manera del uso de este software, incluso si se advierte de la posibilidad de tales daños.

**Al usar StreamScan, aceptas estos términos y reconoces que la responsabilidad recae únicamente sobre tus acciones y el contenido que procesas.**
